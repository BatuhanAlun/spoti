...
-- t_users tablosu, username ve password sütunlarını içerir.
...
-- +goose Down
-- Bu migration, t_users ve t_roles tablolarını siler.
-- Silme işlemi Foreign Key kısıtlamaları nedeniyle t_users tablosuyla başlamalıdır.
